...
Throughout this assignment, I observed several limitations of large language models. Although I did not encounter any obvious cases of fabricated information in my interactions, I noticed that responses can sometimes contain inaccuracies or incomplete details, meaning outputs should not automatically be assumed to be correct. I also found that LLMs may struggle with complex reasoning and calculations when not guided through a structured process, occasionally producing incorrect answers while appearing confident. In addition, while bias can be a limitation of AI systems in general, I did not observe any clear gender bias in the responses generated during this assignment, as the descriptions provided used gender-neutral language and avoided making assumptions about professions based on gender.

To use LLMs responsibly, it is important to verify important facts and claims using reliable external sources, especially in academic, medical, legal, or financial contexts. LLMs should be viewed as tools that assist and support decision-making rather than replace human judgment, particularly in situations where accuracy and accountability are important. Additionally, users should be transparent about AI assistance, avoid presenting AI-generated content as entirely their own work, and carefully review outputs for potential errors, inaccuracies, or unintended bias before using or sharing them.
